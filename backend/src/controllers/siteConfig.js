...
export class SiteConfigController {
  ...
  async updateConfigs(request) {
    try {
      ...
      if (!configs || typeof configs !== 'object') {
        return createErrorResponse('配置数据格式错误', 400);
      }

      await this.db.updateSiteConfigs(configs);

      return createResponse({ message: '配置更新成功' });
  ...
  async uploadAsset(request) {
    try {
      ...
      return createErrorResponse('上传失败'， 500);
    }
  }
  ...
  async deleteAsset(request) {
    try {
      ...
      return createResponse({ message: '资源删除成功' });
  ...
  async createFooterLink(request) {
    try {
      ...
      return createErrorResponse('创建链接失败', 500);
    }
  }
  ...
  async updateFooterLink(request) {
    try {
      ...
      return createResponse({ message: '链接更新成功' });

    } catch (error) {
      console.error('Update footer link error:', error);
      return createErrorResponse('更新链接失败', 500);
    }
  }
  ...
  async deleteFooterLink(request) {
    try {
      ...
      return createResponse({ message: '链接删除成功' });

    } catch (error) {
      console.error('Delete footer link error:', error);
      return createErrorResponse('删除链接失败', 500);
    }
  }
  ...
  async createAnnouncement(request) {
    try {
      ...
      return createErrorResponse('创建公告失败', 500);
    }
  }
  ...
  async updateAnnouncement(request) {
    try {
      ...
      return createResponse({ message: '公告更新成功' });

    } catch (error) {
      console.error('Update announcement error:', error);
      return createErrorResponse('更新公告失败', 500);
    }
  }
  ...
  async deleteAnnouncement(request) {
    try {
      ...
      return createResponse({ message: '公告删除成功' });

    } catch (error) {
      console.error('Delete announcement error:', error);
      return createErrorResponse('删除公告失败', 500);
    }
  }
  ...
  async getEmailTemplates(request) {
    try {
      ...
      return createErrorResponse('获取邮件模板失败', 500);
    }
  }
  ...
  async createEmailTemplate(request) {
    try {
      ...
      if (error.message.includes('UNIQUE constraint failed')) {
        return createErrorResponse('模板名称已存在', 400);
      }
      return createErrorResponse('创建邮件模板失败', 500);
    }
  }
  ...
  async updateEmailTemplate(request) {
    try {
      ...
      return createErrorResponse('更新邮件模板失败', 500);
    }
  }
  ...
  async deleteEmailTemplate(request) {
    try {
      ...
      return createResponse({ message: '邮件模板删除成功' });

    } catch (error) {
      console.error('Delete email template error:', error);
      return createErrorResponse('删除邮件模板失败', 500);
    }
  }
  ...
  async testEmailTemplate(request) {
    try {
      ...
      if (result.success) {
        return createResponse({ message: '测试邮件发送成功' });
      } else {
        return createErrorResponse(`测试邮件发送失败: ${result.error}`, 500);
      }

    } catch (error) {
      console。error('Test email template error:'， error);
      return createErrorResponse('测试邮件发送失败'， 500);
    }
  }
  ...
  async previewEmailTemplate(request) {
    try {
      ...
      return createErrorResponse('预览邮件模板失败'， 500);
    }
  }
}
